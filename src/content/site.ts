...
const images = {
  ...
  savannah: "/images/akagera-elephant-herd.jpeg",
  forest: "/images/nyungwe-chimpanzee.jpeg",
  lake: "/images/lake-kivu-sunset.png",
  elephant: "/images/elephant-water-crossing.jpeg",
  plains: "/images/akagera-lion.jpeg",
  chimpanzee: "/images/chimpanzee-forest-rest.jpeg",
  leopard: "/images/east-africa-leopard.jpeg",
  zebra: "/images/zebras-at-water.jpeg",
};
...
export const tours: Tour[] = [
  ...
  tour({ slug: "great-lakes-gorilla-savannah", title: "Great Lakes Gorilla & Savannah Safari", region: "Rwanda · Uganda", duration: "16 days", category: "Grand journey", summary: "A scenic Great Lakes route pairing intimate primate encounters with expansive wildlife country.", image: images.zebra, highlights: ["Rwanda and Uganda", "Gorillas", "Savannah wildlife", "Great Lakes scenery"], stops: ["Arrive Kigali", "Kigali stories", "Akagera", "Akagera safari", "To Volcanoes", "Gorilla trekking", "Lake Kivu", "Cross to Uganda", "Lake Bunyonyi", "Bwindi", "Gorilla trek", "Queen Elizabeth", "Kazinga Channel", "Kibale", "Chimpanzees", "Depart Entebbe"] }),
  tour({ slug: "rwanda-uganda-tanzania-expedition", title: "Rwanda, Uganda & Tanzania Expedition", region: "The northern safari circuit", duration: "18 days", category: "Expedition", summary: "Three countries, rare primates and Tanzania’s legendary plains in one carefully connected expedition.", image: images.leopard, highlights: ["Three countries", "Gorillas and chimpanzees", "Serengeti", "Ngorongoro"], stops: ["Arrive Kigali", "Kigali", "Volcanoes", "Gorilla trekking", "Cross to Uganda", "Bwindi", "Queen Elizabeth", "Kazinga Channel", "Kibale", "Chimpanzees", "Fly to Tanzania", "Arusha", "Tarangire", "Ngorongoro", "Central Serengeti", "Serengeti safari", "Serengeti at leisure", "Departure"] }),
