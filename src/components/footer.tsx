...
export function Footer() {
  ...
  return <footer>
    ...
    <div className="footer-grid">
      <div><Link className="footer-brand" href="/" aria-label="Bru Safaris home"><Image src="/images/bru-safaris-logo.png" alt="Bru Safaris" width={112} height={112}/><b>BRU SAFARIS</b></Link><p>Private journeys, thoughtfully designed by a team on the ground in Kicukiro, Kigali.</p></div>
